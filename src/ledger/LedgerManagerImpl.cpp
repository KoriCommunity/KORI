...
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_FEE = 1;  //CHANGED BASE FEE TO 1 STROOP
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_RESERVE = 1;   //CHANGED GENESIS BASE RESERVE TO 1 STROOP
