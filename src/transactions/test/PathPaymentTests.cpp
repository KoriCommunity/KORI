...
TEST_CASE("pathpayment", "[tx][pathpayment]")
{
    ...
    SECTION("dest amount too big for KRI")
    {
    ...
    SECTION("path payment KRI with not enough funds")
    {
        auto market = TestMarket{*app};
    ...
    SECTION("path payment over send max KRI")
    {
        auto market = TestMarket{*app};
    ...
    SECTION("path payment to self KRI")
    {
        auto market = TestMarket{*app};
    ...
    SECTION("path payment with cycle")
    {
        for_all_versions(*app, [&] {
            ...
            // buying price is
            // always half - so sender buys 8 times as much KRI
            // as he/she
            // sells (arbitrage).
            // Second cycle involves 3 transaction in which
            // buying price is
            // always two - so sender buys 8 times as much KRI
            // as he/she
